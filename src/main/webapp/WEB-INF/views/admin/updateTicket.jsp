			...
			<div class="row" style="margin-top: 100px;">
				...
				<div class="container-wrapper; col-9" style="margin-top: -20px; color: white">
					<div class="container">
						...
						<table>
							<form:form items="${ticketVO}" var="ticket">
								<tr>
									<td><input type="hidden" value="${ticketVO.gnum} }"></td>
								</tr>
								<tr>
									<td><input type="text" value="${ticketVO.tcost}"></td>
								</tr>
								<tr>
								...
								<input type="submit" a href="/admin/updateTicket" class="btn btn-light">
							</form:form>
						</table>
						<br />
					</div>
