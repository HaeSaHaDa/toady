...
<body>
					...
					<table class="table" style="width: 850px; table-layout: fixed;" border="1" cellpadding="1" cellspacing="10" border="1">
						...
						<c:forEach var="board" items="${eventList}">
							<tr>
								<td>${board.bid}</td>
								<td>${board.tname}</td>
								<td><a href="eventBoardView/${board.bid}" style="color: inherit">${board.btitle}</a></td>
								<td>${board.bdate}</td>
							</tr>
						</c:forEach>
						<tr>
							<td>
								<button type="button" value="글쓰기">
									<a href="/admin/adminWriteBoardView">글쓰기</a>
								</button>
							</td>
						</tr>
					</table>
	...
	<!-- Footer Section End -->	<!-- Get In Touch Section Begin -->
	<div class="gettouch-section">
		<div class="container">
			<div class="row">
				<div class="col-md-4">
