						...
						<div class="container">
							<form name="form">
								...
								<div class="form-group">
									<input type="hidden" class="form-control" value="${principal.user.mid}" maxlength="50px" name="userId" id="mid">
								</div>
								<div class="form-group">
									<label for="password" style="color: white">Change Password:</label> <input type="password" class="form-control" placeholder="Enter password" id="mpassword" name="password1">
								</div>
								<div class="form-group">
									<label for="password" style="color: white">Change Password Check:</label> <input type="password" class="form-control" placeholder="Enter password" name="password2">
								</div>
